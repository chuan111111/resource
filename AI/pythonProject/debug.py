...
def main():
    ...
    with open(f'./Testcase/Heuristic/map1/seed', 'r') as f:
        line = f.readline()
    ...
    for generation in range(generations):
        ...
        # 二进制锦标赛选择新的种群
        selected_population = binary_tournament_selection(population, n,new_Grapgh1,new_Grapgh2,fitness_scores)
    ...
    with open(f'./Testcase/Heuristic/map1/try.txt',  "w") as objective_value_file:
...
def binary_tournament_selection(population, n,Graph1,Graph2,fitness_scores):
    # 二进制锦标赛选择
    selected_population = []

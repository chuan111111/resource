...
def main():
    ...
    with open(f'./Testcase/Evaluator/map1/dataset1', 'r') as f:
        line = f.readline()
    ...
    with open(f'./Testcase/Evaluator/map1/seed', 'r') as f:
        line = f.readline()
    ...
    with open(f'./Testcase/Evaluator/map1/seed_balanced', 'r') as f:
        line = f.readline()

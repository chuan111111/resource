...
public class Client {
   static AirConditioner roomAirConditioner = new AirConditioner("bedRoom");
    static AirConditioner livingAirConditioner = new AirConditioner("livingRoom");
    static Light roomLight = new Light("bedRoom");
static     Light livingLight = new Light("livingRoom");
    ...
    RemoteCommandQueue remoteCommandQueue=new RemoteCommandQueue();
        ...
        System.out.println("Please input operation number to add a command: 1-9,[1,3,5,7] is on command,\n" +

...
public class ViewReplied extends JFrame {
    private int WIDTH;
    ...
    private void loadData() {
        String sql = "select posts.post_id,title from posts join replies on posts.post_id = replies.post_id where reply_author='"+Menu.user+"';";

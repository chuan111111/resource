...
public class ViewPost extends JFrame {
    ...
    private void loadData() {
        String sql = "select post_id,title from posts except select posts.post_id, title from posts join(select post_id from post_author_relation join shield on author_name=shielded where relation='P' and shielders='"+ Menu.user +"')x on x.post_id=posts.post_id order by post_id;";

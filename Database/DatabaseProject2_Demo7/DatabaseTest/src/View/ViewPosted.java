...
public class ViewPosted extends JFrame {
    private int WIDTH;
    ...
    private void loadData() {
        String sql = "select posts.post_id, title from posts join post_author_relation on posts.post_id = post_author_relation.post_id where author_name='"+Menu.user+"'and relation='P';";
